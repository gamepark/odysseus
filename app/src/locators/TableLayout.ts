 ...
 *
 * The ship board is laid out lengthwise, bow up (see ShipBoardPlaceLocator): it fills the left of the
 ...
 *   ship board          24.52 wide once turned, centered on x = -23.7   → -35.96 .. -11.44
 ...
 *
 * Vertical: the ship board, 49.02 once turned, is by far the tallest piece, so the table is cut flush
