...
// An ordered stock, heaped at the ship's stern — which the board turned bow up (see ShipBoardPlaceLocator)
// puts at the bottom of the table — just below the Epic tiles, the last thing printed there. The whole right
...
export const athenaFavorSupplyLocator = new DeckLocator({ coordinates: { x: -23.7, y: 19.6, z: 1 } })
